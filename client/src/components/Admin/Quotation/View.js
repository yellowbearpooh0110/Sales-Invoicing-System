              ...
              orders[orderIndex].ChairStocks.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {`${item.ChairToQuotation.unitPrice} HKD`}
                    </Typography>
                    <Typography
                      variant="span"
                      color={red[100]}
                    ...
                    >
                      {`Amount: ${item.ChairToQuotation.qty}`}
                    </Typography>
                  </Box>
                </ListItem>
              ))}
              ...
              orders[orderIndex].DeskStocks.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {`${item.DeskToQuotation.unitPrice} HKD`}
                    </Typography>
                    <Typography
                      variant="span"
                      color={red[100]}
                    ...
                    >
                      {`Amount: ${item.DeskToQuotation.qty}`}
                    </Typography>
                  </Box>
                </ListItem>
              ))}
              ...
              orders[orderIndex].AccessoryStocks.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {`${item.AccessoryToQuotation.unitPrice} HKD`}
                    </Typography>
                    <Typography
                      variant="span"
                      color={red[100]}
                    ...
                    >
                      {`Amount: ${item.AccessoryToQuotation.qty}`}
                    </Typography>
                  </Box>
                </ListItem>
              ))}
